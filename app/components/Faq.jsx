...
export function Faq() {
    return (
        <div className="flex flex-col w-full py-[48px] lg:py-[60px] lg:flex-row lg:gap-x-[24px]">
            <div className="lg:2-1/3 lg:py-[32px] lg:pr-[56px]">
                <h3 className="text-[#EB2891] text-[14px] font-medium lg:text-base">
                    Frequently asked questions
                </h3>
                <h1 className="py-4 text-[24px] fot-medium text-[#172026] lg:text-[42px] lg:leading-[56px]">
                            ...
                            <Accordion.Item value={`item-$(index + 1)`} className="bg-[#E3F1FF] p-[16px] rounded-[8px]">
                                ...
                                <Accordion.Header>
                                    <Accordion.Trigger className="flex w-full items-center justify-between">
                                        ...
                                        <span>
                                            <Image src={Plus} alt="plus button" className="h-10 w-10 lg:w-6 lg:h-6"/>
                                        </span>
